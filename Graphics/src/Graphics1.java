	...
	public DrawFrame(String title) {
		...
		for (int i = 0; i < 3; i++) {
			for (int j = 0; j < 5; j++) {
				...
				ster[i][j] = new Gster(x, i * 50 + 50, Color.yellow);
			}
		}
		moon = new Gmoon[1];
		moon[0] = new Gmoon(400, 100, Color.yellow);

		build = new Gbuilding[2];
		build[0] = new Gbuilding(150, 350, Color.gray);
		build[1] = new Gbuilding(350, 300, Color.red);
	}
